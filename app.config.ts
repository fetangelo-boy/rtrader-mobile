...
const rawBundleId = "space.manus.rtrader.mobile.t20260330035026";
const bundleId =
  rawBundleId
...
const env = {
  ...
  appName: "RTrader",
  appSlug: "rtrader-mobile",
  // S3 URL of the app logo - set this to the URL returned by generate_image when creating custom logo
  // Leave empty to use the default icon from assets/images/icon.png
  logoUrl: "https://d2xsxph8kpxj0f.cloudfront.net/310519663493343814/GjSezgKcr9WWcHDU2BtnCu/rtrader-icon-LBvvvTcxvRKSwpS4urn2yM.png",
...
const config: ExpoConfig = {
  ...
  extra: {
    eas: {
      projectId: "ce28f86e-b240-4163-af3a-35788c6ea176",
    },
