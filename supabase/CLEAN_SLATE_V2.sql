-- Clean slate V2: Drop all tables and recreate with correct order
-- Create tables first WITHOUT policies, then add policies after all tables exist
...
-- Step 3: Create chats table (WITHOUT policies yet)
CREATE TABLE chats (
  id TEXT PRIMARY KEY,
  name TEXT NOT NULL,
  description TEXT,
...
-- Step 4: Create chat_participants table (WITHOUT policies yet)
...
-- Step 5: Create messages table (WITHOUT policies yet)
...
-- Step 6: Create chat_settings table (WITHOUT policies yet)
...
-- Step 7: Create subscriptions table (WITHOUT policies yet)
...
-- ============================================================================
-- NOW enable RLS and add policies (after all tables exist)
-- ============================================================================
