-- Simplified fix: Convert all chat_id columns from UUID to TEXT
-- Execute this in one go
...
SELECT id, chat_id::TEXT as chat_id, user_id, role, joined_at
...
-- Step 7: Add foreign key constraints for chat_id
ALTER TABLE chat_participants
