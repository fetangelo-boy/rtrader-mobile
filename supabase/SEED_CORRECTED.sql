-- RTrader Mobile MVP - Seed Data
-- Apply after all migrations are complete
...
-- Insert test profile
-- ============================================================================
-- Note: The profile must exist in auth.users first. This assumes the user
-- cf0d0cc4-cb26-4adf-9b49-69fbc4cec7dd already exists in Supabase Auth.
...
-- ============================================================================
-- Add test user as participant in all chats
-- (as 'participant' for interactive, 'subscriber' for info-only)
-- ============================================================================
